...
public class ConfigurationTask {
  ...
  public ConfigurationTask(ConfigurationAction configAction, Executor executor) {
    this.executor = executor;
    this.configAction = configAction;
  }

  public void executeAsync() {
    executor.execute(new ConfigTaskRunner());
  }
  ...
  private class ConfigTaskRunner implements Runnable {
    ...
    public void run() {
      try {
        ...
        FutureTask<?> t = new FutureTask<>(configAction, null);

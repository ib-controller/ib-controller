...
public class SwingUtils {
  ...
  /**
   * Traverses a container hierarchy and returns the button with the given text.
   * 
   * @param container
  ...
  /**
   * Traverses a container hierarchy and returns the checkbox with the given text.
   * 
   * @param container
   *          the Container to search in
   * @param text
   ...
   */
  public static JCheckBox findCheckBox(Container container, String text) {
    ComponentIterator iter = new ComponentIterator(container);
    while (iter.hasNext()) {
      Component component = iter.next();
  ...
  /**
   * Traverses a container hierarchy and returns the ith JComboBox (0 based
   * indexing).
   *
   * @param container
   *          the Container to search in
   * @param ith
   *          specifies which JComboBox to return (the first one is specified by
   *          0, the next by 1, etc)
  ...
  /**
   * Traverses a container hierarchy and returns the Component with the given
   * text.
   * 
   * @param container
   *          the Container to search in
  ...
  /**
   * Traverses a container hierarchy and returns the radio button with the given
   * text.
   * 
   * @param container
   *          the Container to search in
  ...
  /**
   * Traverses a container hierarchy and returns the JTextLabel that contains the
   * given substring.
   * 
   * @param container
   *          the Container to search in
  ...
  /**
   * Traverses a container hierarchy and returns the ith JTextField (0 based
   * indexing).
   *
   * @param container
   *          the Container to search in
   * @param ith
   *          specifies which JTextField to return (the first one is specified by
   *          0, the next by 1, etc)
   * @return the required JTextField if it is found, otherwise null
   */
  public static JTextField findTextField(Container container, int ith) {
    ComponentIterator iter = new ComponentIterator(container);
    int i = 0;
    while (iter.hasNext()) {
      Component component = iter.next();
  ...
  /**
   * Traverses a container hierarchy and returns the first JMenuBar it finds.
   * 
   * @param container
   *          the Container to search in
  ...
  /**
   * Traverses a container hierarchy and returns the ith JMenuBar (0 based
   * indexing).
   *
   * @param container
   *          the Container to search in
  ...
  /**
   * Searches a MenuElement's subelements for the JMenuItem with the given text.
   * 
   * @param container
  ...
  /**
   * Traverses a container hierarchy and returns the JMenuItem with the given path
   * from the first JMenuBar encountered, or null if the first JMenuBar doesn't
   * contain an item with that path
   *
   * @param container
   *          the Container to search in
   * @param path
  ...
  /**
   * Traverses a container hierarchy and returns the JMenuItem with the given path
   * from the first JMenuBar that contains it
   *
   * @param container
   *          the Container to search in
   * @param path
  ...
  /**
   * Traverses a JMenubar's menu structure for a JMenuItem with the specified path
   * 
   * @param menuBar
  ...
  /**
   * Traverses a container hierarchy and returns the first JOptionPane it finds.
   * 
   * @param container
   *          the Container to search in
  ...
  /**
   * Traverses a container hierarchy and returns the first JTree it finds.
   * 
   * @param container
   *          the Container to search in
  ...
  /**
   * Returns the node with the given text below the given node in the specified
   * TreeModel
   * 
   * @param model
   ...
   * @return true if the JButton is enabled; false if there is no such JButton, or
   *         it is disabled
   */
   ...
   * @return true if the JCheckBox is enabled; false if there is no such
   *         JCheckBox, or it is not selected
   */
   ...
   * @return true if the JRadioButton is enabled; false if there is no such
   *         JRadioButton, or it is not selected
   */
   ...
   * 
   * Details of each component in the window are included, indented to reflect the
   * component's position in the hierarchy.
   * 
   * @param window
   ...
   * @param fieldNumber
   *          the number of the required JTextField in the window, counting from 0
   * @param value
  ...
  /**
   * Indicates whether the specified window's title is the same as the given
   * string.
   * 
   * @param window
   *          the window to be checked
